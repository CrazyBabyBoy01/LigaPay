...
class AccountServiceFilterForm(forms.Form):
    ...
    account_level_min = forms.IntegerField(
        required=False,
        widget=forms.NumberInput(
            attrs={'id': 'account_level_min', 'name': 'account_level_min', 'placeholder': 'От'}
        ),
    )
    account_level_max = forms.IntegerField(
        required=False,
        widget=forms.NumberInput(
            attrs={'id': 'account_level_max', 'name': 'account_level_max', 'placeholder': 'До'}
        ),
    )
    ...
    skin_count_min = forms.IntegerField(
        required=False,
        widget=forms.NumberInput(
            attrs={'id': 'skin_count_min', 'name': 'skin_count_min', 'placeholder': 'От'}
        ),
    )
    skin_count_max = forms.IntegerField(
        required=False,
        widget=forms.NumberInput(
            attrs={'id': 'skin_count_max', 'name': 'skin_count_max', 'placeholder': 'До'}
        ),
    )
